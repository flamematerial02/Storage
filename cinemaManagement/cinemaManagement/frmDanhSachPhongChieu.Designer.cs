...
{
	partial class danhSachPhongChieu
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.groupBox2.Text = "Chi Tiết & Tìm Kiếm";
			this.groupBox2.Enter += new System.EventHandler(this.GroupBox2Enter);
			// 
			// button1
			// 
			this.button1.AutoSize = true;
			this.button1.Location = new System.Drawing.Point(153, 53);
			...
			this.Name = "danhSachPhongChieu";
			this.Text = "danhSachPhongChieu";
